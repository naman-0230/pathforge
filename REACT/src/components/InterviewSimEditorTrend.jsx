import { getInterviewSimEditorTrendData, getInterviewSimEditorEngagementStats } from '../utils/interviewSim.js';

// InterviewSimEditorTrend — visualizes editor pass rate across interview
// simulation sessions over time. Same shape as Custom + Weekly test trends.

const WIDTH = 500;
const HEIGHT = 180;
const PADDING = { top: 20, right: 20, bottom: 30, left: 40 };

export default function InterviewSimEditorTrend() {
  const stats = getInterviewSimEditorEngagementStats();
  const trendData = getInterviewSimEditorTrendData().filter((d) => d.passRate !== null);
  ...
  if (stats.attemptedInEditor === 0) {
    return (
      <div style={{
        ...
        <p>
          No editor submissions yet in your interview sims.
          <br />
          Attempt problems in the code editor during sims to see your pass rate trend here.
        </p>
      </div>
    );
  }
    ...
    return (
      <div>
        ...
        <div style={{
          ...
          Complete more interview sims with editor submissions to see pass rate trend.
        </div>
      </div>
    );
  }
    ...
    <div>
      ...
      <div style={{ padding: '12px 16px' }}>
        ...
        <div style={{
          ...
          Hover any point to see session details
        </div>
      </div>
    </div>
  );
